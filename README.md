...
3. Set the URL as `https://joschaap.github.io/beat-saber-overlay/` and the size equal to your canvas size (1280x720, etc.)

![image](https://imgur.com/KxowYrw.png)

4. (Optional) For 1080p canvases, add the `scale` modifier (ex. `https://joschaap.github.io/beat-saber-overlay/?modifiers=scale`) to scale the overlay by 1.5x
...
```
https://joschaap.github.io/beat-saber-overlay/?modifiers=top
```
